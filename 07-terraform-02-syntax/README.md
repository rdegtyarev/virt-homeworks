...
### Решение
1. Ответ на вопрос: при помощи какого инструмента (из разобранных на прошлом занятии) можно создать свой образ ami?
>Можно воспользоваться консолью управления AWS. Образ ami можно создать из предварительно созданного инстанса, либо воспользоваться EC2 Image Builder.
1. Ссылку на репозиторий с исходной конфигурацией терраформа.  
>https://github.com/rdegtyarev/netologty-terraform  
